...
CASTING     : TIPO '(' OPERACOES ')'
            {
    
            }| VARIAVEIS TIPO '(' OPERACOES ')'{
                
            }


//Declaração GERAL ---------------------------------------------------------------------------
DECLARACAO	: TK_ID ATRIBUICAO DECLARACAO_MULTIPLA{
				//Criar tabela para guardar variavel 
				string var = addNewVar();
				decl += "\t"+ tipoDeclaracao +" " + var + ";\n";
				//insere variavel na tabela
				addNewVarToTable( $1.label, var, tipoDeclaracao);
				$$.label = var;
				$$.tipo = tipoDeclaracao;
...
DECLARACAO_MULTIPLA : ',' DECLARACAO 
            {
...
OPERACOES   : 
            ...
            |TK_ID  OPERADOR OPERACOES{
                
            } 
            |TK_ID{
                
            }
            |CASTING OPERADOR OPERACOES{
...
NUMEROS     :  TK_INT
			{
			    cout << "ENtrou NUMEROS: " <<  $1.label  << endl;
